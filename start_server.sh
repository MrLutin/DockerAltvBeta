...
wget --no-cache "https://cdn.altv.mp/node-module/release/x64_linux/libnode.so.72" -O ./libnode.so.72
wget --no-cache "https://cdn.altv.mp/node-module/release/x64_linux/modules/libnode-module.so" -O ./modules/libnode-module.so
